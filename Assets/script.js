...
var pastSearch = function (pastSearch) {
    ...
    pastSearchEl.classList.add("dataBt")
    pastSearchButtonEl.prepend(pastSearchEl);
    var dataBtEl = document.querySelectorAll(".dataBt")
    for (var i = 0; i < dataBtEl.length; i++) {
        dataBtEl[i].addEventListener("click", function (event) {
